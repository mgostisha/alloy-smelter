...
module.exports = function(_params){
	...
	request.get({
		...
		var body = JSON.parse(res.body);
			releases = _params.branch !== '3_3_X' ? JSON.parse(new Buffer(body.content, 'base64').toString() : JSON.parse(new Buffer(body.content, 'base64').toString().replace('"3.3.0.v20140524224144"\n        "modules"', '"3.3.0.v20140524224144","modules"'));
